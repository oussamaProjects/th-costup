  ...
  >
    ...
    <div class="px-1" style="width: 8%">
      <input
        ...
        type="number"
        placeholder="qty"
        :class="'qty ' + this.globalClass.inputTextForm"
    ...
    <div class="px-1" style="width: 8%">
      <input
        ...
        :class="'occup_hour ' + this.globalClass.inputTextForm"
        @change.prevent="calculate"
      />
    </div>
    ...
    <div class="px-1" style="width: 8%">
      <!-- <input
        ...
        type="number"
        placeholder="price"
        :class="'price ' + this.globalClass.inputTextForm"
        @change.prevent="calculate"
      /> -->
    ...
    <div class="px-1" style="width: 8%">
      <!-- 
        <input
              :value="total"
              type="number"
              :class="'total ' + this.globalClass.inputTextForm"
              name="total"
              placeholder="Total"
    ...
    <div class="px-1" style="width: 8%">
      <input
        ...
        :class="'profit_margin_p_c ' + this.globalClass.inputTextForm"
        @change.prevent="calculate"
      />
    </div>
